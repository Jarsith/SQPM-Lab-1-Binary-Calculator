...
public class BinaryTest 
{
    ...
    public void orTest() {
        ...
        assertTrue(result.getValue().equals("1110")); // Expected OR result: 1110
    }
    ...
    public void orTestDifferentLengths() {
        ...
        Binary binary2 = new Binary("11");
        Binary result = Binary.or(binary1, binary2);
        assertTrue(result.getValue().equals("111")); // Expected OR result: 111
    }
    ...
    public void andTest() {
        ...
        assertTrue(result.getValue().equals("1000")); // Expected AND result: 1000
    }

    /**
     * Test The AND function with binary numbers of different lengths
     * After ANDing, it removes the padded zeroes so the answer is optimized
     * and returns the least amount of digits necessary
     */
    @Test
    public void andTestDifferentLengths() {
        ...
        Binary binary2 = new Binary("11");
        Binary result = Binary.and(binary1, binary2);
        assertTrue(result.getValue().equals("1")); // Expected AND result: 1
    }
    ...
    public void multiplyTest() {
        ...
        assertTrue(result.getValue().equals("1111")); // Expected Multiply result: 1111
    }

    /**
     * Test The Multiply function with binary numbers of different lengths
     */
    @Test
    public void multiplyTestDifferentLengths() {
        Binary binary1 = new Binary("10");
        Binary binary2 = new Binary("101");
        Binary result = Binary.multiply(binary1, binary2);
        assertTrue(result.getValue().equals("1010")); // Expected Multiply result: 1010
    }
}
